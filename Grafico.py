...
def graficowQ(alpha, wq, mu):
    ...
    for alf in tmp:
        ...
        plt.plot(asseX, assiY[i], label='alpha='+str(alf), color=colori(alpha,alf))
    ...
    plt.xlabel("ro")
    plt.legend()
    plt.savefig("Grafico teorico di wQ al variare di ro fissato alpha.png")
    plt.show()
    plt.close()
...
def graficowQa(alpha, wq, mu):
    ...
    for mo in tmp:
        ...
        plt.plot(asseX, assiY[i], label='mu='+str(mo), color=colori(mu,mo))
    ...
    plt.xlabel("alpha")
    plt.legend()
    plt.savefig("Grafico teorico di wQ al variare di alpha.png")
    plt.show()
    plt.close()
...
def graficowQm(alpha, wq, mu):
    ...
    plt.xlabel("mu")
    plt.legend()
    plt.savefig("Grafico teorico di wQ al variare di mu.png")
    plt.show()
    plt.close()
...
def graficowS(alpha, ws, mu):
    ...
    plt.ylabel("wS*mu^2+mu")
    plt.xlabel("ro")
    plt.legend()
    plt.savefig("Grafico teorico di wS al variare di ro fissato alpha.png")
    plt.show()
    plt.close()
...
def graficowSa(alpha, ws, mu):
    ...
    plt.xlabel("alpha")
    plt.legend()
    plt.savefig("Grafico teorico di wS al variare di alpha.png")
    plt.show()
    plt.close()
...
def graficowSm(alpha, ws, mu):
    ...
    plt.xlabel("mu")
    plt.legend()
    plt.savefig("Grafico teorico di wS al variare di mu.png")
    plt.show()
    plt.close()
...
def graficolQa(alpha, lq, mu):
    ...
    plt.xlabel("ro")
    plt.legend()
    plt.savefig("Grafico teorico di lQ al variare di alpha.png")
    plt.show()
    plt.close()
...
def graficolSa(alpha, ls, mu):
    ...
    plt.xlabel("alpha")
    plt.legend()
    plt.savefig("Grafico teorico di lS rispetto ad alpha.png")
    plt.show()
    plt.close()
